...
class RefundRequest(models.Model):
    ...
    # Use the local STATUS_CHOICES for refund requests
    status = models.CharField(max_length=20, choices=STATUS_CHOICES, default='pending')  #get_status_display() will return the human-readable version of the status
    created_at = models.DateTimeField()
    updated_at = models.DateTimeField()
